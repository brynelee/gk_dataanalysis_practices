...
# 数据加载
emails = pd.read_csv("../tools/gk-data-analysis/PageRank/input/Emails.csv")
# 读取别名文件
file = pd.read_csv("../tools/gk-data-analysis/PageRank/input/Aliases.csv")
aliases = {}
for index, row in file.iterrows():
    aliases[row['Alias']] = row['PersonId']
# 读取人名文件
file = pd.read_csv("../tools/gk-data-analysis/PageRank/input/Persons.csv")
persons = {}
for index, row in file.iterrows():
